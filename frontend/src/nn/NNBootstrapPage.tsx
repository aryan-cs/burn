  ...
  alexnet_cats_dogs: {
    graph: {
      nodes: [
        ...
        { id: 'node_2', type: 'Conv2D', config: { filters: 64, kernel_size: 11, stride: 4, padding: 2, activation: 'relu', name: 'conv1' } },
        { id: 'node_3', type: 'MaxPool2D', config: { kernel_size: 3, stride: 2, padding: 0, name: 'pool1' } },
        { id: 'node_4', type: 'Conv2D', config: { filters: 192, kernel_size: 5, stride: 1, padding: 2, activation: 'relu', name: 'conv2' } },
        ...
        { id: 'node_7', type: 'Conv2D', config: { filters: 256, kernel_size: 3, stride: 1, padding: 1, activation: 'relu', name: 'conv4' } },
